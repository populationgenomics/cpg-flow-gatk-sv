...
# stolen from https://github.com/broadinstitute/seqr-loading-pipelines/blob/c113106204165e22b7a8c629054e94533615e7d2
# ...hail_scripts/elasticsearch/elasticsearch_client_v7.py#L20
...
def encode_field_name(s):
    ...
    https://github.com/broadinstitute/seqr-loading-pipelines/blob/c113106204165e22b7a8c629054e94533615e7d2
    ...hail_scripts/elasticsearch/elasticsearch_utils.py#L123
...
def struct_to_dict(struct):
    """
    https://github.com/broadinstitute/seqr-loading-pipelines/blob/c113106204165e22b7a8c629054e94533615e7d2
    ...hail_scripts/elasticsearch/hail_elasticsearch_client.py#L21
    """
...
class ElasticsearchClient:
    """
    Clone of https://github.com/broadinstitute/seqr-loading-pipelines/blob/c113106204165e22b7a8c629054e94533615e7d2
    ...hail_scripts/elasticsearch/hail_elasticsearch_client.py#L25
    """
    ...
    def __init__(self, host: str, port: str, es_username: str, es_password: str):
        ...
        # check connection
        loguru.logger.info(self.es.info())
    ...
    def create_mapping(self, index_name, elasticsearch_schema, num_shards=1, _meta=None):
        ...
        https://github.com/broadinstitute/seqr-loading-pipelines/blob/c113106204165e22b7a8c629054e94533615e7d2
        ...hail_scripts/elasticsearch/elasticsearch_client_v7.py#L62
        ...
        if _meta:
            loguru.logger.info(f'==> index _meta: {_meta}')
    ...
    def export_table_to_elasticsearch(self, table, index_name, num_shards):
        ...
        for original_name, encoded_name in rename_dict.items():
            loguru.logger.info(f'Encoding column name {original_name} to {encoded_name}')
...
def main():
    ...
    loguru.logger.info(f'Connecting to ElasticSearch: host="{host}", port="{port}", user="{username}"')
    ...
    # https://github.com/broadinstitute/seqr-loading-pipelines/blob/c113106204165e22b7a8c629054e94533615e7d2
    # ...luigi_pipeline/lib/hail_tasks.py#L273
